        ...
        <div :class="sidebarOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'" class="fixed z-30 inset-y-0 left-0 w-64 transition duration-300 transform bg-gray-900 overflow-y-auto lg:translate-x-0 lg:static lg:inset-0">
            ...
            <nav class="mt-10">
                ...
                <a class="flex items-center mt-4 py-2 px-6 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100"
                    ...
                    <span class="mx-3">Go To Home</span>
                </a>
                                ...
                                <table class="min-w-full">
                                    ...
                                    <tbody class="bg-white">
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                <span
                                                    class="text-sm leading-5 text-gray-900">Lorem ipsum dolor sit amet consectetur adipisicing elit. Laudantium necessitatibus quidem natus aliquid eaque aperiam eum architecto, veritatis autem nemo.</span>
                                            </td>
                                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                <p
                                                    class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-100 text-green-800">Active</p>
                                            </td>
