                            ...
                            <div class="w-full px-6 sm:w-1/2 xl:w-1/3">
                                <div class="flex items-center px-5 py-6 shadow-sm rounded-md bg-white">
                                    ...
                                    <div class="mx-5">
                                        ...
                                        <a href="{{ route('portfolio.create')}}" class="text-gray-500">Create article</a>
                                    ...
                                    <tbody class="bg-white">
                                        ...
                                        <tr>
                                            ...
                                            <td
                                                ...
                                                <a href="{{ route('portfolio.edit', $item->id) }}" class="text-indigo-600 hover:text-indigo-900">Edit</a>
                                            </td>
                                            <td
